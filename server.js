    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [{
        price_data: {
          currency: 'eur',
          product_data: {
            name: 'Copies Bac/Brevet 2025',
            description: 'Nous vous rappelons que les copies obtenus sont confidentiels, toutes données est sécurisés et interdit à la vente',
          },
